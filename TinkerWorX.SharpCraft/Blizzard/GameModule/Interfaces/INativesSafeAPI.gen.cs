...
{
    public partial interface INativesSafeAPI
    {
        ...
        JassObjectId UnitId(String unitIdString);
        String UnitId2String(JassObjectId unitId);
        JassObjectId AbilityId(String abilityIdString);
        String AbilityId2String(JassInteger abilityId);
        String GetObjectName(JassObjectId objectId);
        ...
        JassObjectId GetSpellAbilityId();
        ...
        JassDestructable CreateDestructable(JassObjectId objectid, Single x, Single y, Single face, Single scale, JassInteger variation);
        JassDestructable CreateDestructableZ(JassObjectId objectid, Single x, Single y, Single z, Single face, Single scale, JassInteger variation);
        JassDestructable CreateDeadDestructable(JassObjectId objectid, Single x, Single y, Single face, Single scale, JassInteger variation);
        JassDestructable CreateDeadDestructableZ(JassObjectId objectid, Single x, Single y, Single z, Single face, Single scale, JassInteger variation);
        ...
        JassObjectId GetDestructableTypeId(JassDestructable d);
        ...
        JassItem CreateItem(JassObjectId itemid, Single x, Single y);
        void RemoveItem(JassItem whichItem);
        JassPlayer GetItemPlayer(JassItem whichItem);
        JassObjectId GetItemTypeId(JassItem i);
        ...
        Boolean IsItemIdPowerup(JassObjectId itemId);
        Boolean IsItemIdSellable(JassObjectId itemId);
        Boolean IsItemIdPawnable(JassObjectId itemId);
        ...
        void SetItemDropID(JassItem whichItem, JassObjectId unitId);
        ...
        JassUnit CreateUnit(JassPlayer id, JassObjectId unitid, Single x, Single y, Single face);
        JassUnit CreateUnitByName(JassPlayer whichPlayer, String unitname, Single x, Single y, Single face);
        JassUnit CreateUnitAtLoc(JassPlayer id, JassObjectId unitid, JassLocation whichLocation, Single face);
        JassUnit CreateUnitAtLocByName(JassPlayer id, String unitname, JassLocation whichLocation, Single face);
        JassUnit CreateCorpse(JassPlayer whichPlayer, JassObjectId unitid, Single x, Single y, Single face);
        ...
        void SelectHeroSkill(JassUnit whichHero, JassObjectId abilcode);
        JassInteger GetUnitAbilityLevel(JassUnit whichUnit, JassObjectId abilcode);
        JassInteger DecUnitAbilityLevel(JassUnit whichUnit, JassObjectId abilcode);
        JassInteger IncUnitAbilityLevel(JassUnit whichUnit, JassObjectId abilcode);
        JassInteger SetUnitAbilityLevel(JassUnit whichUnit, JassObjectId abilcode, JassInteger level);
        ...
        JassItem UnitAddItemById(JassUnit whichUnit, JassObjectId itemId);
        Boolean UnitAddItemToSlotById(JassUnit whichUnit, JassObjectId itemId, JassInteger itemSlot);
        ...
        JassObjectId GetUnitTypeId(JassUnit whichUnit);
        ...
        JassInteger GetFoodMade(JassObjectId unitId);
        JassInteger GetFoodUsed(JassObjectId unitId);
        ...
        Boolean IsHeroUnitId(JassObjectId unitId);
        Boolean IsUnitIdType(JassObjectId unitId, JassUnitType whichUnitType);
        ...
        Boolean IssueBuildOrderById(JassUnit whichPeon, JassObjectId unitId, Single x, Single y);
        Boolean IssueNeutralImmediateOrder(JassPlayer forWhichPlayer, JassUnit neutralStructure, String unitToBuild);
        Boolean IssueNeutralImmediateOrderById(JassPlayer forWhichPlayer, JassUnit neutralStructure, JassObjectId unitId);
        Boolean IssueNeutralPointOrder(JassPlayer forWhichPlayer, JassUnit neutralStructure, String unitToBuild, Single x, Single y);
        Boolean IssueNeutralPointOrderById(JassPlayer forWhichPlayer, JassUnit neutralStructure, JassObjectId unitId, Single x, Single y);
        Boolean IssueNeutralTargetOrder(JassPlayer forWhichPlayer, JassUnit neutralStructure, String unitToBuild, JassWidget target);
        Boolean IssueNeutralTargetOrderById(JassPlayer forWhichPlayer, JassUnit neutralStructure, JassObjectId unitId, JassWidget target);
        ...
        void AddItemToAllStock(JassObjectId itemId, JassInteger currentStock, JassInteger stockMax);
        void AddItemToStock(JassUnit whichUnit, JassObjectId itemId, JassInteger currentStock, JassInteger stockMax);
        void AddUnitToAllStock(JassObjectId unitId, JassInteger currentStock, JassInteger stockMax);
        void AddUnitToStock(JassUnit whichUnit, JassObjectId unitId, JassInteger currentStock, JassInteger stockMax);
        void RemoveItemFromAllStock(JassObjectId itemId);
        void RemoveItemFromStock(JassUnit whichUnit, JassObjectId itemId);
        void RemoveUnitFromAllStock(JassObjectId unitId);
        void RemoveUnitFromStock(JassUnit whichUnit, JassObjectId unitId);
        ...
        void SetPlayerAbilityAvailable(JassPlayer whichPlayer, JassObjectId abilid, Boolean avail);
        ...
        void UnitPoolAddUnitType(JassUnitPool whichPool, JassObjectId unitId, Single weight);
        void UnitPoolRemoveUnitType(JassUnitPool whichPool, JassObjectId unitId);
        ...
        void ItemPoolAddItemType(JassItemPool whichItemPool, JassObjectId itemId, Single weight);
        void ItemPoolRemoveItemType(JassItemPool whichItemPool, JassObjectId itemId);
        ...
        void SetDoodadAnimation(Single x, Single y, Single radius, JassObjectId doodadID, Boolean nearestOnly, String animName, Boolean animRandom);
        void SetDoodadAnimationRect(JassRect r, JassObjectId doodadID, String animName, Boolean animRandom);
